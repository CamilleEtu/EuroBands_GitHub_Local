...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 09 nov. 2022 à 14:58
...
CREATE TABLE `artiste` (
  ...
  `bio_anglais` text NOT NULL,
  `nation_artiste` varchar(50) NOT NULL,
  `url_video_artiste` varchar(200) NOT NULL,
  `url_image_artiste` varchar(200) NOT NULL
...
INSERT INTO `festivalier` (`id_festivalier`, `nom_festivalier`, `prenom_festivalier`, `mail_festivalier`) VALUES
(1, 'a', 'a', 'a@a.a'),
(2, 'b', 'b', 'b@b.b'),
(3, 'b', 'b', 'b@b.b'),
(4, 'h', 'h', 'h@h.h'),
...
INSERT INTO `reserve` (`id_festivalier`, `id_jour`) VALUES
(1, 1),
(2, 2),
(3, 2),
(4, 3),
...
--
ALTER TABLE `artiste`
  MODIFY `id_artiste` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT pour la table `festivalier`
--
ALTER TABLE `festivalier`
  MODIFY `id_festivalier` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
