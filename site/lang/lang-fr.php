...
define('index_p1', 'En 2023, nous célébrons les 30 ans de la création de l’Union Européenne. A cette occasion, Le Puy en Velay a choisi d’organiser un événement exceptionnel, à la hauteur de cet anniversaire. 4 soirées, 12 artistes et groupes venus des 4 coins de l’Europe. 
Venez célébrer cet événement unique du <strong>22 au 25 juin 2023, place du Breuil au Puy en Velay</strong>. Pour célébrer l\'interculturalité de l’événement, les concerts seront retransmis  à la télévision, et dans différents pays d’Europe, il sera possible d’y assister en version holographique.</br> ');

define("index_more", "Voir Plus");

define("index_nombre_artiste", "Nombre d'artistes présents pour EuroBands : ");
...
// Page reservation ---------------------------------------------------
define('resa_titre1', "Réservation gratuite");
